...
public class FlowManagerJSON {
	...
	public static List<String> getSwitchList() throws JSONException, IOException{
			
		List<String> switchList = new ArrayList<String>();
		
			// Get the string IDs of all the switches
				json = Deserializer.readJsonArrayFromURL("http://" + IP + ":8080/wm/core/controller/switches/json");
	...
	public static List<String> getFlowList(String dpid) throws JSONException, IOException{
		
		List<String> flowList = new ArrayList<String>();
		
			// Get the string names of all the specified switch's flows
				obj = Deserializer.readJsonObjectFromURL("http://" + IP + ":8080/wm/staticflowentrypusher/list/" + dpid + "/json");
	...
	public static Flow getFlow(String dpid, String flowName) throws IOException, JSONException{
			// Get the string names of all the specified switch's flows
				obj = Deserializer.readJsonObjectFromURL("http://" + IP + ":8080/wm/staticflowentrypusher/list/" + dpid + "/json");
