...
public class TablesDisplay {
		...
		protected void createContents() {
			...
			shell.setText("Table Information for Switch ID:" + selectedSwitch.getStringId());
				...
				gl_shell.createParallelGroup(GroupLayout.LEADING)
					.add(GroupLayout.TRAILING, gl_shell.createSequentialGroup()
						...
						.add(gl_shell.createParallelGroup(GroupLayout.TRAILING)
							.add(GroupLayout.LEADING, composite, GroupLayout.DEFAULT_SIZE, 774, Short.MAX_VALUE)
							.add(GroupLayout.LEADING, toolBar, GroupLayout.DEFAULT_SIZE, 774, Short.MAX_VALUE))
						.addContainerGap())
			);
			gl_shell.setVerticalGroup(
				gl_shell.createParallelGroup(GroupLayout.LEADING)
					.add(gl_shell.createSequentialGroup()
						...
						.add(composite, GroupLayout.PREFERRED_SIZE, 544, GroupLayout.PREFERRED_SIZE)
			...
			switchTable_table.addListener(SWT.Selection, new Listener() {
			      public void handleEvent(Event e) {
			        ...
			        // At the moment the 1.0 spec only really supports one table and we can't specify to get flows from a certain table ID.
			        // So we just pass the switch and get all the static flows from that switch.
			       // try{
			...
			TableColumn tblclmnNewColumn_1 = new TableColumn(switchTable_table, SWT.NONE);
			tblclmnNewColumn_1.setWidth(100);
			tblclmnNewColumn_1.setText("Name");
			
			TableColumn tblclmnNewColumn_2 = new TableColumn(switchTable_table, SWT.NONE);
			tblclmnNewColumn_2.setWidth(50);
			tblclmnNewColumn_2.setText("ID");
			
			TableColumn tblclmnNewColumnn = new TableColumn(switchTable_table, SWT.NONE);
			tblclmnNewColumnn.setWidth(150);
			tblclmnNewColumnn.setText("Active Count");
			
			TableColumn tblclmnNewColumn = new TableColumn(switchTable_table, SWT.NONE);
			tblclmnNewColumn.setWidth(150);
			tblclmnNewColumn.setText("Lookup Count");
			
			TableColumn tblclmnNewColumn_3 = new TableColumn(switchTable_table, SWT.NONE);
			tblclmnNewColumn_3.setWidth(150);
			tblclmnNewColumn_3.setText("Matched Count");
			
			TableColumn tblclmnNewColumn_4 = new TableColumn(switchTable_table, SWT.NONE);
			tblclmnNewColumn_4.setWidth(100);
			tblclmnNewColumn_4.setText("Max Entries");
			
			TableColumn tblclmnNewColumn_5 = new TableColumn(switchTable_table, SWT.NONE);
			...
			tltmSwitches.addSelectionListener(new SelectionAdapter() {
				@Override
				public void widgetSelected(SelectionEvent e) {
					switchTableData = net.floodlightcontroller.avior.controller.Table.getTableData(selectedSwitch);
			...
			if(net.floodlightcontroller.avior.controller.Table.getTableData(selectedSwitch) != null){
			switchTableData = net.floodlightcontroller.avior.controller.Table.getTableData(selectedSwitch);
			displaySwitchTableData(switchTableData);
			}
