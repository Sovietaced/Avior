...
import controller.overview.json.Switches;
	...
	public class Gui {
		...
		protected Label lblInsertHostname, lblInsertHealthy, lblInsertJvmMemory, lblInsertModules;
		...
		protected void createContents() {
			...
			TableColumn tblclmnNewColumn_1 = new TableColumn(switches_table, SWT.NONE);
			tblclmnNewColumn_1.setWidth(200);
			tblclmnNewColumn_1.setText("DPID");
			
			TableColumn tblclmnNewColumn_2 = new TableColumn(switches_table, SWT.NONE);
			...
			TableColumn tblclmnNewColumn_3 = new TableColumn(switches_table, SWT.NONE);
			tblclmnNewColumn_3.setWidth(100);
			tblclmnNewColumn_3.setText("Bytes");
			
			TableColumn tblclmnNewColumn_9 = new TableColumn(switches_table, SWT.NONE);
